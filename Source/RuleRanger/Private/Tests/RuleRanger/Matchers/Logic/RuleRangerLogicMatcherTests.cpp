...
namespace RuleRangerLogicMatcherTests
{
    bool SetMatchers(FAutomationTestBase& Test,
                     UObject* MatcherObject,
                     const TCHAR* PropertyName,
                     const TArray<TObjectPtr<URuleRangerMatcher>>& Matchers)
    {
        return RuleRangerTests::SetPropertyValue(Test, MatcherObject, PropertyName, Matchers);
    }
} // namespace RuleRangerLogicMatcherTests
...
bool FRuleRangerAndMatcherSkipsNullChildrenTest::RunTest(const FString&)
{
    ...
    if (TestNotNull(TEXT("And matcher should be created"), Matcher)
        ...
        && TestNotNull(TEXT("Object should be created"), Object))
    {
        return RuleRangerLogicMatcherTests::SetMatchers(*this, Matcher, TEXT("Matchers"), { nullptr, ChildMatcher })
...
bool FRuleRangerAndMatcherShortCircuitsOnFirstFalseTest::RunTest(const FString&)
{
        ...
        && TestNotNull(TEXT("Object should be created"), Object))
    {
        if (RuleRangerTests::SetPropertyValue(*this, FirstMatcher, TEXT("bResult"), false)
            && RuleRangerLogicMatcherTests::SetMatchers(*this,
                                                        Matcher,
                                                        TEXT("Matchers"),
        ...
        && TestNotNull(TEXT("Object should be created"), Object))
    {
        if (RuleRangerTests::SetPropertyValue(*this, FirstMatcher, TEXT("bResult"), true)
            && RuleRangerLogicMatcherTests::SetMatchers(*this,
                                                        Matcher,
                                                        TEXT("Matchers"),
                                                        { nullptr, FirstMatcher, SecondMatcher }))
        {
