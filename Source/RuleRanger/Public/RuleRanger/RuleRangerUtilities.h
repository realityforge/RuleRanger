...
public:
     ...
     * the list.
     */
    RULERANGER_API static void CollectTypeHierarchy(const UObject* Object, TArray<UClass*>& Classes);
     ...
     */
    RULERANGER_API static void CollectInstanceHierarchy(UObject* Object, TArray<UObject*>& Instances);
